...
// Ambil data untuk edit bidang ilmu
// Jika ada parameter edit di URL, ambil data untuk diedit
$edit = null;
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
...
// Jika ada parameter hapus di URL, hapus data
if (isset($_GET['hapus'])) {
    $id = $_GET['hapus'];
...
<div class="container-fluid px-4">
    <h2 class="mt-5">Data Bidang Ilmu</h2>
