...
// Tambah hubungan dosen-kegiatan
...
// Update hubungan dosen-kegiatan
...
// Ambil data untuk edit dosen-kegiatan
$edit = null;
if (isset($_GET['edit'])) {
...
// Ambil data pehubungan dosen-kegiatan
...
// Ambil data untuk dropdown dosen dan kegiatan
...
<div class="container-fluid px-4">
    <h2 class="mt-5">Dosen dan Kegiatan</h2>

    <!-- Form tambah/edit relasi -->
    <div class="card mb-4">
        <div class="card-header mb-3 p-5 bg-dark">
            <form method="POST" class="row g-2 align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <?php else: ?>
                        <button name="tambah" class="btn btn-primary mt-3">Tambah</button>
                    <?php endif; ?>
                </div>
            </form>
        </div>
