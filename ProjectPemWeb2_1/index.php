                ...
                <main >
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard grafik kegiatan dosen</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card-body"><?= $jml_dosen ?> Dosen</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dosen.php" style="text-decoration: none;">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card-body"><?= $jml_prodi ?> Program Studi</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="prodi.php"style="text-decoration: none;" >View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card-body"><?= $jml_kegiatan ?> Kegiatan</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="kegiatan.php"style="text-decoration: none;" >View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card-body"><?= $jml_penelitian ?> Penelitian</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="penelitian.php"style="text-decoration: none;" >View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">
                                Copyright &copy; Zhahara N Sukirman <?= date('Y'); ?>
                            </div>
                            <div>
    ...
    new Chart(document.getElementById("myBarChart"), {
        ...
        data: {
            ...
            datasets: [{
                label: "Jumlah Dosen",
                data: jumlahData,
                backgroundColor: "rgba(49, 49, 49, 0.37)",
                borderWidth: 1
            }]
        },
        options: {
